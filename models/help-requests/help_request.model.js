...
class HelpRequestModel {
  ...
  async getAllCallbacks(params) {
    try {
      ...
      await axios
        .get(config.help_requests_callback_api_url, {
          headers: headers,
          params: params,
        })
        .then((result) => {
        ...
        .catch((err) => {
          data = handleAPIErrors(
            err,
            "Axios catch Error at HelpRequestModel: getAllCallbacks())"
          );
          data.isError = true;
        });
      return data;
  ...
  async getAllHelpRequests(params) {
    try {
      ...
      await axios
        .get(config.help_requests_api_url, {
          headers: headers,
          params: params,
        })
        .then((result) => {
        ...
        .catch((err) => {
          data = handleAPIErrors(
            err,
            "Axios catch Error at HelpRequestModel: fetchAllHelpRequests())"
          );
          data.isError = true;
        });
      console.log("RESULTT");
  ...
  async getHelpRequest(id) {
    try {
      ...
      await axios
        .get(config.help_requests_api_url + "/" + id, {
          headers: headers,
        })
        .then((result) => {
          data = result;
        ...
        .catch((err) => {
          data = handleAPIErrors(
            err,
            "Axios catch Error at HelpRequestModel: getHelpRequest())"
          );
          data.isError = true;
        });
  ...
  async createHelpRequest(helpRequestdata) {
    try {
      ...
      await axios
        .post(config.help_requests_api_url, helpRequestdata, {
          headers: headers,
        })
        .then((result) => {
          data = result;
        ...
        .catch((err) => {
          data = handleAPIErrors(
            err,
            "Axios catch Error at HelpRequestModel: createHelpRequest()"
          );
          data.isError = true;
        });
  ...
  async updateHelpRequest(id, helpRequestdata) {
    try {
      ...
      await axios
        .patch(config.help_requests_api_url + "/" + id, helpRequestdata, {
          headers: headers,
        })
        .then((result) => {
          data = result;
        ...
        .catch((err) => {
          data = handleAPIErrors(
            err,
            "Axios catch Error at HelpRequestModel: updateHelpRequest()"
          );
          data.isError = true;
        });
