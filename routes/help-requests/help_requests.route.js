...
router.get(
  "/complete/:id",
  isAuthorised,
  helpRequestsController.help_request_complete_get
);
...
router.get(
  "/address/:id",
  isAuthorised,
  helpRequestsController.help_request_edit_address_get
);
...
router.get(
  "/create",
  isAuthorised,
  helpRequestsController.help_request_create_get
);

// POST request to get all help requests by postcode
router.post(
  "/search",
  [isAuthorised, searchResidentValidation],
  (req, res, next) => {
...
router.post(
  "/edit/:id",
  [isAuthorised, helpRequestEditValidation],
  (req, res, next) => {
...
router.post(
  "/create",
  [isAuthorised, helpRequestCreateValidation],
  (req, res, next) => {
...
router.post(
  "/address/:id",
  [isAuthorised, addressValidation],
  (req, res, next) => {
